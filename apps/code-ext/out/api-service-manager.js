...
class ApiServiceManager {
    ...
    apiPort = 8167;
    apiHost = 'localhost';
    serviceName = 'com.claude-projects.api';
    plistName = 'com.claude-projects.api.plist';
    outputChannel;
    deploymentMode = 'local';
    awsEndpoint;
    awsApiKey;
    awsRegion;
    mongodbUri = 'mongodb://localhost:27017/claude-projects';
    apiKeys = [];
    ...
    loadConfiguration() {
        ...
        if (mongoMode === 'local') {
            ...
            this.mongodbUri = mongodbConfig.get('customUri', 'mongodb://localhost:27017/claude-projects');
        }
        else {
            // Fallback to legacy setting if it exists
            this.mongodbUri = config.get('local.mongodbUri', 'mongodb://localhost:27017/claude-projects');
        }
        // AWS settings
