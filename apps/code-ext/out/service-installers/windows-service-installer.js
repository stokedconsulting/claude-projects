    ...
    async install() {
        try {
            ...
            if (!nssmAvailable) {
                ...
                vscode.window.showErrorMessage('NSSM is required to install the Claude Projects service on Windows. Please install NSSM from https://nssm.cc/ and restart VSCode.', 'Open NSSM Website').then(selection => {
