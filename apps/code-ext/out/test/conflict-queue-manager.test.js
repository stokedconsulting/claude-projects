...
suite('ConflictQueueManager Test Suite', () => {
    ...
    setup(() => {
        ...
        manager = new conflict_queue_manager_1.ConflictQueueManager(tempDir);
    ...
    teardown(() => {
        ...
        (0, conflict_queue_manager_1.cleanupConflictQueueManager)();
    });
    ...
    test('should persist conflicts across manager instances', async () => {
        ...
        // Create new instance
        const newManager = new conflict_queue_manager_1.ConflictQueueManager(tempDir);
    ...
    test('should handle global singleton pattern', () => {
        ...
        const globalManager = (0, conflict_queue_manager_1.initializeConflictQueueManager)(tempDir);
        assert.ok(globalManager);
        // Get global instance
        const retrievedManager = (0, conflict_queue_manager_1.getConflictQueueManager)();
        assert.strictEqual(retrievedManager, globalManager);
        // Cleanup
        (0, conflict_queue_manager_1.cleanupConflictQueueManager)();
        // Should throw after cleanup
        assert.throws(() => {
            (0, conflict_queue_manager_1.getConflictQueueManager)();
...
//# sourceMappingURL=conflict-queue-manager.test.js.map