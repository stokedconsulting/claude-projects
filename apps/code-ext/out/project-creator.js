...
exports.formatProjectCreateInput = formatProjectCreateInput;
exports.parseProjectCreateResponse = parseProjectCreateResponse;
exports.addProjectLabels = addProjectLabels;
exports.enqueueNewProject = enqueueNewProject;
exports.trackSelfGeneratedProject = trackSelfGeneratedProject;
exports.getWeeklyGenerationRate = getWeeklyGenerationRate;
exports.createProjectFromIdea = createProjectFromIdea;
exports.getAllSelfGeneratedProjects = getAllSelfGeneratedProjects;
exports.getSelfGeneratedProjectsByCategory = getSelfGeneratedProjectsByCategory;
exports.clearSelfGeneratedProjects = clearSelfGeneratedProjects;
 ...
 */
function formatProjectCreateInput(idea) {
    const lines = [];
 ...
 */
function parseProjectCreateResponse(response) {
 ...
 */
async function simulateProjectCreate(input) {
 ...
 */
async function addProjectLabels(issueNumber, category) {
    // For now, log the operation
    // In production, this would use GitHub API:
    // - POST /repos/{owner}/{repo}/issues/{issueNumber}/labels
    // - Body: ["agent-generated", `category:${category}`]
    console.log(`[ProjectCreator] Adding labels to issue #${issueNumber}: agent-generated, category:${category}`);
    // Simulate API delay
 ...
 */
async function enqueueNewProject(projectNumber, issueNumber, queueManager) {
    console.log(`[ProjectCreator] Enqueueing project #${projectNumber} (issue #${issueNumber}) to work queue`);
 ...
 */
function getSelfGeneratedFilePath() {
 ...
 */
function loadSelfGeneratedProjects() {
 ...
 */
function saveSelfGeneratedProjects(data) {
    ...
    try {
        ...
        throw new Error(`Failed to save self-generated projects: ${error instanceof Error ? error.message : String(error)}`);
    }
}
/**
 ...
 */
async function trackSelfGeneratedProject(data) {
    const storage = loadSelfGeneratedProjects();
    // Check if already tracked (prevent duplicates)
    const exists = storage.projects.some(p => p.projectNumber === data.projectNumber && p.issueNumber === data.issueNumber);
    if (exists) {
        console.log(`[ProjectCreator] Project #${data.projectNumber} already tracked`);
        return;
    }
    storage.projects.push(data);
    saveSelfGeneratedProjects(storage);
    console.log(`[ProjectCreator] Tracked self-generated project #${data.projectNumber} (category: ${data.category})`);
}
/**
 ...
 */
async function getWeeklyGenerationRate(category) {
    const storage = loadSelfGeneratedProjects();
 ...
 */
async function createProjectFromIdea(idea, agentId, queueManager) {
    ...
    try {
        ...
        // Success!
        console.log(`[ProjectCreator] Successfully created project #${projectNumber} (issue #${issueNumber})`);
        return {
            success: true,
            projectNumber,
            issueNumber,
 ...
 */
async function getAllSelfGeneratedProjects() {
    const storage = loadSelfGeneratedProjects();
 ...
 */
async function getSelfGeneratedProjectsByCategory(category) {
    const storage = loadSelfGeneratedProjects();
 ...
 */
async function clearSelfGeneratedProjects() {
