...
exports.isPhaseMaster = isPhaseMaster;
exports.extractPhaseInfo = extractPhaseInfo;
exports.extractMasterTitle = extractMasterTitle;
exports.groupItemsByPhase = groupItemsByPhase;
exports.calculatePhaseStatus = calculatePhaseStatus;
/**
 ...
 */
function extractPhaseInfo(item) {
 ...
 */
function extractMasterTitle(title) {
    if (!title)
        return '';
 ...
 */
function hasExplicitMasterIndicator(title) {
...
function calculatePhaseStatus(phase) {
    if (!phase.masterItem || phase.workItems.length === 0)
        return null;
...
//# sourceMappingURL=phase-logic.js.map